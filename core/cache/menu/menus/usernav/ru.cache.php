  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'description' => 'Выйти из панели управления',
        'icon' => '',
        'menuindex' => 2,
        'params' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'description' => 'Управление пользовательскими настройками MODX',
        'icon' => '',
        'menuindex' => 1,
        'params' => '',
        'handler' => '',
      ...
      array (
        ...
        'description' => 'Управление действиями и структурой верхнего меню панели управления',
        'icon' => '',
        'menuindex' => 4,
        'params' => '',
        'handler' => '',
      ...
      array (
        ...
        'description' => 'Изменение языковых строк в панели управления',
        'icon' => '',
        'menuindex' => 7,
        'params' => '',
        'handler' => '',
