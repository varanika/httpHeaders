...
class httpHeadersOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('httpheaders_item_err_ns');
        }
...
return 'httpHeadersOfficeItemUpdateProcessor';
